...
public abstract class AbsBaseAdapter<T> extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //从数据源中获得数据 放入ViewHolder的对象控件里
        binDatas(viewHolder, datas.get(position));
        return convertView;
    }

    protected abstract void binDatas(ViewHolder viewHolder, T data);

    /**
     * 将布局中的控件缓存，以便下次使用时不再findViewById
     */
